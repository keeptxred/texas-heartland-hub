...
import mortgagePaymentGuide from "@/assets/texas-mortgage-payment-guide.jpg";
import closingCostsGuide from "@/assets/texas-closing-costs-guide.jpg";
import utilityCostsGuide from "@/assets/texas-utility-costs-guide.jpg";
import homeInsuranceGuide from "@/assets/texas-home-insurance-guide.jpg";
import salaryAffordabilityGuide from "@/assets/texas-salary-home-affordability.jpg";

export const ARTICLES: Article[] = [
  {
    slug: "texas-mortgage-payment-guide",
    category: "Non-Political",
    title: "Texas Mortgage Payment Guide: What Your Monthly Payment Really Includes",
    dek: "Learn how principal, interest, property taxes, homeowners insurance, mortgage insurance, and HOA dues combine into a Texas monthly house payment.",
    author: "Keep TX Red Data Desk",
    date: "July 25, 2026",
    publishedAt: "2026-07-25T12:00:00-05:00",
    image: mortgagePaymentGuide,
    pillar: true,
    contentCategory: "housing",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["housing", "mortgage", "home buying", "personal finance"],
    subcategory: "home-buying",
  },
  {
    slug: "texas-closing-costs-guide",
    category: "Non-Political",
    title: "Texas Closing Costs Explained: A Buyer’s Cash-to-Close Guide",
    dek: "Understand lender fees, title charges, escrow deposits, prepaid taxes, insurance, and the other expenses Texas buyers should budget for before closing.",
    author: "Keep TX Red Data Desk",
    date: "July 25, 2026",
    publishedAt: "2026-07-25T11:45:00-05:00",
    image: closingCostsGuide,
    pillar: true,
    contentCategory: "housing",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["housing", "closing costs", "home buying", "personal finance"],
    subcategory: "home-buying",
  },
  {
    slug: "texas-utility-costs-guide",
    category: "Non-Political",
    title: "Texas Utility Costs: How to Build a Realistic Monthly Budget",
    dek: "A practical guide to estimating Texas electricity, water, natural gas, internet, trash, and seasonal utility costs before you move or buy.",
    author: "Keep TX Red Data Desk",
    date: "July 25, 2026",
    publishedAt: "2026-07-25T11:30:00-05:00",
    image: utilityCostsGuide,
    pillar: true,
    contentCategory: "cost-of-living",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["utilities", "cost of living", "electricity", "relocation"],
    subcategory: "household-costs",
  },
  {
    slug: "texas-homeowners-insurance-guide",
    category: "Non-Political",
    title: "Texas Homeowners Insurance: Coverage, Deductibles, and Cost Drivers",
    dek: "Learn what a Texas home policy usually covers, why wind and hail deductibles matter, when flood insurance is separate, and how to compare quotes.",
    author: "Keep TX Red Data Desk",
    date: "July 25, 2026",
    publishedAt: "2026-07-25T11:15:00-05:00",
    image: homeInsuranceGuide,
    pillar: true,
    contentCategory: "financial",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["insurance", "housing", "homeowners insurance", "personal finance"],
    subcategory: "home-buying",
  },
  {
    ...
    dek: "Turn a target home price into a realistic income and monthly budget using debt-to-income, down payment, taxes, insurance, and emergency reserves.",
    author: "Keep TX Red Data Desk",
    date: "July 25, 2026",
    publishedAt: "2026-07-25T11:00:00-05:00",
    image: salaryAffordabilityGuide,
    pillar: true,
    contentCategory: "financial",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["salary", "home affordability", "housing", "personal finance"],
    subcategory: "home-buying",
  },
  {
    slug: "2026-07-11-unt-appoints-scholar-focused-on-race-and-neoliberalism-as-interim-provost",
    category: "Education",
    title: "UNT Appoints Scholar Focused on Race and Neoliberalism as Interim Provost",
    dek: "Albert Bimper, a higher-education administrator whose scholarship includes race, college athletics, and neoliberalism, has been selected as the University of North Texas interim provost.",
    author: "Keep TX Red Newsroom",
    date: "July 11, 2026",
    publishedAt: "2026-07-11T09:00:00-05:00",
    image: classroom,
    contentCategory: "government-policy",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["education", "higher education", "UNT"],
  },
  {
    slug: "live-2026-07-07-texas-pitmasters-to-feature-in-new-food-network-competition-series-v3wglp",
    category: "Non-Political",
    title: "Food Network BBQ Competition: Texas Pitmasters to Headline New Series",
    dek: "Texas barbecue culture takes center stage as four Lone Star State pitmasters compete in Food Network's new series “Pitmasters.”",
    author: "Keep TX Red Newsroom",
    date: "July 7, 2026",
    publishedAt: "2026-07-07T09:00:00-05:00",
    image: suburb,
    contentCategory: "culture",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["Texas culture", "barbecue", "food"],
  },
  {
    slug: "2026-07-06-rangers-texas-rangers-prospect-guide-the-next-stars-of-arlington",
    category: "Non-Political",
    title: "Texas Rangers Prospect Guide: The Next Stars of Arlington",
    dek: "A guide to the young players shaping the Rangers’ farm system, led by elite shortstop prospect Sebastian Walcott.",
    author: "Keep TX Red Sports Desk",
    date: "July 6, 2026",
    publishedAt: "2026-07-06T09:00:00-05:00",
    image: boardroom,
    contentCategory: "lifestyle",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["sports", "baseball", "Texas Rangers"],
  },
  {
    slug: "live-2026-07-02-secretary-of-state-releases-july-3-texas-register-detailing-new-state--m0th5w",
    category: "Legislature",
    title: "Texas Register July 3 Edition: New State Agency Rules and Rulemaking Updates Released",
    dek: "The July 3 Texas Register records proposed and adopted state-agency rules, public notices, and other executive-branch actions.",
    author: "Keep TX Red Newsroom",
    date: "July 2, 2026",
    publishedAt: "2026-07-02T09:00:00-05:00",
    image: openmeeting,
    contentCategory: "regulations",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["Texas government", "regulations", "Texas Register"],
  },
  {
    slug: "live-2026-06-29-the-history-behind-the-texas-stock-tank-name-bxkvg7",
    category: "Non-Political",
    title: "The History Behind the Texas “Stock Tank” Name",
    dek: "Why Texans often call a small ranch pond a stock tank—and how a practical livestock-water term became part of the state’s vocabulary.",
    author: "Keep TX Red Newsroom",
    date: "June 29, 2026",
    publishedAt: "2026-06-29T09:00:00-05:00",
    image: water,
    contentCategory: "history",
    lastReviewedDate: "2026-07-25",
    dateModified: "2026-07-25",
    topics: ["Texas history", "ranching", "Texas culture"],
  },
  {
