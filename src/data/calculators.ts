...
export const calculators: CalculatorDirectoryItem[] = [
  ...
  { id: "texas-relocation-budget-planner", title: "Texas Relocation Budget Planner", slug: "/tools/texas-relocation-budget-planner", description: "Estimate moving costs, deposits, vehicle and license fees, travel, contingency funds, and the emergency savings needed for a move to Texas.", category: "Relocation", icon: "MapPinned", keywords: ["texas relocation budget planner", "cost to move to texas", "texas moving cost calculator", "moving to texas budget", "texas relocation expenses"], featured: true },
  { id: "texas-monthly-living-cost-calculator", title: "Texas Monthly Living Cost Calculator", slug: "/tools/texas-monthly-living-cost-calculator", description: "Build a complete monthly Texas household budget including housing, utilities, groceries, transportation, healthcare, childcare, and savings.", category: "Relocation", icon: "Wallet", keywords: ["texas monthly living cost calculator", "texas household budget", "cost to live in texas", "monthly expenses texas"], featured: true },
  { id: "texas-commute-cost-calculator", title: "Texas Commute Cost Calculator", slug: "/tools/texas-commute-cost-calculator", description: "Estimate fuel, tolls, parking, vehicle wear, and time costs for a Texas commute.", category: "Financial", icon: "Car", keywords: ["texas commute cost calculator", "texas toll cost", "commuting cost calculator", "gas cost to work"] },
  { id: "texas-vehicle-fees-estimator", title: "Texas Vehicle Registration & Fees Estimator", slug: "/tools/texas-vehicle-fees-estimator", description: "Estimate Texas vehicle registration, title-transfer, county, processing, and new-resident fees.", category: "Relocation", icon: "BadgeDollarSign", keywords: ["texas vehicle registration fees", "texas title transfer cost", "new resident vehicle fees texas", "texas car registration calculator"] },
  { id: "texas-relocation-checklist-generator", title: "Texas Relocation Checklist Generator", slug: "/tools/texas-relocation-checklist-generator", description: "Generate a personalized moving-to-Texas checklist for the weeks before your move and your first month in Texas.", category: "Relocation", icon: "ListChecks", keywords: ["texas relocation checklist", "moving to texas checklist", "texas new resident checklist", "texas move planner"] },
];
