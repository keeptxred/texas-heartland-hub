...
export const TEXAS_DATA_SETS: TexasDataSet[] = [
  {
    ...
    useCases: ["Compare property-tax burdens and tax-rate changes", "Track whether legislative relief changes local bills", "Analyze appraisal growth versus rate changes", "Support KTR property-tax policy explainers and public-data comparisons with primary-source context"],
    sources: [
