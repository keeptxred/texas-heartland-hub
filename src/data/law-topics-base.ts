...
export const LAW_TOPICS: LawTopic[] = [
  {
    ...
    dek: "A permanent guide to the state and local legal framework behind property-tax authority, appraisal governance, tax-rate adoption, truth-in-taxation, school finance, relief legislation, and implementation.",
    updated: "2026-09-18",
    quickAnswer: "Texas has no state property tax. State law establishes the framework for appraisal, local tax-rate adoption, school finance, transparency, and relief measures, while local taxing units adopt their own budgets and rates. Practical homeowner filing, protest, appraisal-district, calculator, and payment guidance belongs on TexasDefined.",
    appliesTo: ["Texas voters and policy readers", "State lawmakers and agencies", "Cities, counties, school districts, and special districts", "Journalists and researchers tracking property-tax policy"],
    framework: [
      "Texas property taxation is local taxation operating within a state constitutional and statutory framework. Local taxing units levy property taxes; the Legislature sets major rules governing appraisal, rate adoption, transparency, school finance, and relief mechanisms.",
      "Appraisal and tax-rate adoption are separate. Appraisal districts administer values under state law, while local taxing units separately adopt budgets and rates. Policy coverage should identify which part of the system a proposal or change affects.",
      "KTR uses this topic for government authority, legislation, tax-rate policy, school finance, fiscal effects, and implementation. TexasDefined owns practical homeowner tasks including exemptions, protests, appraisal-district lookup, calculators, and payment logistics.",
    ],
    keyRules: [
      "Texas does not impose a general state property tax; local taxing units levy property taxes under state law.",
      "Appraisal districts administer appraisal, while local taxing units separately adopt budgets and rates.",
      "Tax Code Chapter 26 contains major truth-in-taxation and rate-adoption rules.",
      "School property-tax policy interacts with state school-finance formulas and appropriations.",
      "Practical homeowner property-tax tasks belong on TexasDefined rather than KTR's policy-law topic.",
    ],
    questions: [
      { q: "Who controls property-tax policy in Texas?", a: "The Texas Constitution and state law establish the framework, while local taxing units adopt their own budgets and property-tax rates under that framework." },
      { q: "Where should homeowners go for exemptions, protests, appraisal-district help, or tax estimates?", a: "TexasDefined owns those practical homeowner resources. KTR keeps this law topic focused on legislation, government authority, tax-rate policy, school finance, and implementation." },
    ],
    sources: [
      ...
      { label: "Texas Comptroller — Truth-in-Taxation", url: "https://comptroller.texas.gov/taxes/property-tax/truth-in-taxation/" },
    ],
    related: [
