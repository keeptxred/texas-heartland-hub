// Statewide Texas property-tax dataset. `npm run tax-rates:sync` refreshes this file from the Texas Comptroller.
...
export const TAX_RATE_DATASET={taxYear:2025,lastUpdated:"2026-07-22",sourceUrl:"https://comptroller.texas.gov/taxes/property-tax/rates/",countyCount:254} as const;
const COUNTY_NAMES=[
  "Anderson",
  "Andrews",
  "Angelina",
...
const SEEDED:Record<string,Partial<County>>={
...
export const COUNTIES:County[]=COUNTY_NAMES.map((name)=>{
  ...
  return {
    ...
    specialDistricts:seed?.specialDistricts??[],
    taxYear:seed?2024:2025,
    dataSource:seed?"seed-2023-2024":"awaiting-state-refresh",
  };
});
