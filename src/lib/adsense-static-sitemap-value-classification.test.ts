...
const VALUE_CLASSES = {
  collectionOrNavigation: [
    "/", "/news", "/happening-now", "/keep-texas-red", "/houston", "/texas-sports", "/texas-business",
    "/texas-legislature", "/texas-legislature/house", "/texas-legislature/senate", "/texas-legislature/sessions",
    "/texas-government", "/texas-government/agencies", "/districts", "/representatives", "/get-involved",
    "/laws", "/laws/topics", "/data", "/civic-tools", "/topics", "/issues", "/tools", "/texas-politics",
  ...
  authorityReference: [
    ...
    "/issues/texas-policy-handbook", "/issues/texas-government-accountability-handbook", "/issues/texas-local-government-handbook",
    "/texas-politics/texas-constitutional-history", "/texas-politics/texas-election-history", "/texas-politics/texas-redistricting-history", "/texas-politics/voting-rights-history",
    "/texas-politics/republic-of-texas-government-history", "/texas-politics/presidents-of-republic-of-texas", "/texas-politics/congress-of-republic-of-texas", "/texas-politics/constitution-of-1836-republic-of-texas",
    "/texas-politics/republic-of-texas-capitals-government-seats", "/texas-politics/republic-of-texas-diplomacy-recognition", "/texas-politics/texas-annexation-statehood-history", "/texas-politics/republic-of-texas-debt-finance", "/texas-politics/republic-to-state-government-transition",
    ...
    "/texas-politics/democratic-restoration-texas-1874-1900", "/texas-politics/texas-farmers-alliance-populism", "/texas-politics/texas-railroad-commission-regulatory-politics", "/texas-politics/texas-progressive-era-politics", "/texas-politics/james-ferguson-impeachment-1917", "/texas-politics/miriam-ferguson-ku-klux-klan-1920s",
    "/texas-government/texas-government-history", "/texas-government/texas-legislature-history", "/texas-government/governor-history", "/texas-government/lieutenant-governor-history", "/texas-government/speaker-of-the-house-history", "/texas-government/texas-supreme-court-history", "/texas-government/court-of-criminal-appeals-history", "/texas-government/judicial-selection-elections",
    "/texas-government/texas-county-government-history", "/texas-government/commissioners-court-history", "/texas-government/county-judge-history", "/texas-government/county-commissioner-history", "/texas-government/county-sheriff-history", "/texas-government/county-district-clerk-history", "/texas-government/tax-assessor-collector-history", "/texas-government/justice-of-the-peace-constable-history",
    "/texas-government/texas-municipal-government-history", "/texas-government/home-rule-general-law-cities-history", "/texas-government/mayor-city-council-history", "/texas-government/city-manager-government-history", "/texas-government/texas-municipal-courts-history", "/texas-government/texas-special-district-government-history", "/texas-government/municipal-elections-representation-history", "/texas-government/municipal-finance-tax-debt-history",
  ],
  trustOrCommerce: [
...
describe("AdSense static sitemap value classification", () => {
  ...
  it("keeps high-stakes civic/reference pages in the authority class", () => {
    expect(VALUE_CLASSES.authorityReference).toEqual(expect.arrayContaining([
      "/register-to-vote", "/contact-legislators", "/county-elections", "/laws/constitutional-amendments", "/laws/effective-dates",
      "/texas-politics/texas-constitutional-history", "/texas-politics/texas-election-history", "/texas-politics/texas-redistricting-history", "/texas-politics/voting-rights-history",
      "/texas-politics/democratic-restoration-texas-1874-1900", "/texas-politics/texas-farmers-alliance-populism", "/texas-politics/texas-railroad-commission-regulatory-politics", "/texas-politics/texas-progressive-era-politics", "/texas-politics/james-ferguson-impeachment-1917", "/texas-politics/miriam-ferguson-ku-klux-klan-1920s",
      "/texas-government/texas-government-history", "/texas-government/texas-legislature-history", "/texas-government/governor-history", "/texas-government/texas-supreme-court-history", "/texas-government/court-of-criminal-appeals-history",
    ]));
  });
