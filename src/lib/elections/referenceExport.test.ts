...
describe('Election Central public reference export', () => {
  ...
  it('does not leak contact, birth, donation, biography, campaign or internal/admin fields', () => {
    ...
    for (const forbidden of ['private@example.com', '555-0100', '1970-01-01', 'donate.example', 'campaign.example', 'internalNotes', 'secret-test-value', 'Not part of the compact relationship export.']) {
