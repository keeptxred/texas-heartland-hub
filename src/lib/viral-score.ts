...
const HIGH_REP =
  /\b(governor|texas\.gov|attorney general|state of texas|dps|department of public safety|sheriff|police department|police dept|city of |county of |texas tribune|houston chronicle|dallas morning news|dallas news|austin american-statesman|san antonio express|fort worth star-telegram|texas monthly|texas standard|texas public radio|texas legislative reference library|legislative reference library|community impact|kxan|khou|wfaa|kens ?5|kprc(?: 2)?|click2houston|kvia(?: abc-?7)?|abc13|nbc dfw|cbs austin|fox 4|fox 7|associated press|reuters|u\.s\. news|us news|houston methodist|ut southwestern|baylor university medical center|texas a&m|university of texas|texas tech|u-haul|tdlr|texas workforce commission|workforce solutions|espn|mlb\.com|nba\.com|nfl\.com|nhl\.com)\b/i;
const MED_REP =
  /\b(patch\.com|borderreport|san antonio current|tyler morning telegraph|newschannel ?10|local ?news|gazette|herald|tribune|chronicle|journal|star|times|post|record|observer|beacon|weekly|kut|kera|tpr|museum|hospital|university|college|school district|isd)\b/i;
