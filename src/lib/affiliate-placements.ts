...
const SPORTS_EVENT_SIGNAL =
  /\b(home opener|home game|game day|gameday|stadium|arena|ballpark|concert|festival|fest|rodeo|event|series|playoffs?|tournament|race|weekend|tickets?|schedule)\b/i;
