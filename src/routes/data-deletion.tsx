  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          Keep TX Red uses the KeepTXRed Dashboard Meta app (App ID 1358683613078934) to support authorized Facebook Page features. If you connected Facebook to Keep TX Red or TexasDefined through this app and want Facebook-derived data that we control deleted, you may submit a deletion request using the process below.
        </p>
      </section>
