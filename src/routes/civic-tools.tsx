...
export const Route = createFileRoute("/civic-tools")({
  head: () => {
    const seo = buildSeo({
      ...
      description: "Use Keep TX Red civic tools to identify Texas government authority, find relevant Texas laws, track bills, locate representatives, contact lawmakers, and research voting resources.",
      path: "/civic-tools",
    });
