...
const groups = [
  {
    ...
    description:
      "Plan relocation costs, compare salaries and cities, build a budget, and understand the financial side of renting or buying a Texas home.",
    hub: "/moving-to-texas",
    tools: [
      [
        "Texas Moving Cost Calculator",
        "/texas-moving-cost-calculator",
        "Estimate low, expected, and high relocation costs.",
      ],
      [
        "Texas Cost of Living Calculator",
        "/texas-cost-of-living-calculator",
        "Compare household costs across Texas cities.",
      ],
      [
        "Texas Salary Comparison by City",
        "/texas-salary-comparison-by-city",
        "Compare cost-adjusted salary and purchasing power.",
      ],
      [
        "Texas Salary Calculator",
        "/texas-salary-calculator",
        "Estimate Texas take-home pay and household affordability.",
      ],
      [
        "Texas Budget Planner",
        "/texas-budget-planner",
        "Build a monthly household budget and financial-health score.",
      ],
      [
      ...
      [
        ...
        "/texas-mortgage-calculator",
        "Estimate monthly payments and compare interest-rate scenarios.",
      ],
      [
      ...
      [
        ...
        "/texas-down-payment-calculator",
        "Compare down-payment targets and cash requirements.",
      ],
      [
        "Texas Down Payment Assistance Calculator",
        "/texas-down-payment-assistance-calculator",
        "Estimate illustrative assistance and remaining cash needs.",
      ],
      [
  ...
  },
  {
    ...
    description:
      "Manage the ongoing costs of Texas homeownership and household life, including property taxes, insurance, utilities, equity, refinancing, and payoff planning.",
    hub: "/living-in-texas",
    tools: [
      [
        "Texas Property Tax Calculator",
        "/tax-calculator",
        "Estimate property taxes by supported county and school district.",
      ],
      [
        "Texas Property Tax Increase Calculator",
        "/texas-property-tax-increase-calculator",
        "Estimate appraisal-cap and tax-rate changes.",
      ],
      [
        "Texas Homeownership Cost Calculator",
        "/texas-homeownership-cost-calculator",
        "Estimate the full monthly and annual cost of owning a home.",
      ],
      [
        "Texas Home Insurance Calculator",
        "/texas-home-insurance-calculator",
        "Estimate homeowners and optional flood coverage costs.",
      ],
      [
        "Texas Utility Cost Calculator",
        "/texas-utility-cost-calculator",
        "Estimate seasonal electricity, water, gas, internet, and trash costs.",
      ],
      [
        "Texas Home Equity Calculator",
        "/texas-home-equity-calculator",
        "Estimate current equity and available borrowing room.",
      ],
      [
        "Texas Home Equity Growth Calculator",
        "/texas-home-equity-growth-calculator",
        "Project appreciation, loan paydown, and future equity.",
      ],
      [
        "Texas Mortgage Payoff Calculator",
        "/texas-mortgage-payoff-calculator",
        "See how extra payments can shorten your loan.",
      ],
      [
        "Texas Refinance Savings Calculator",
        "/texas-refinance-savings-calculator",
        "Compare refinance savings, costs, and break-even timing.",
      ],
      [
        "Texas Budget Planner",
        "/texas-budget-planner",
        "Build a practical monthly household budget.",
      ],
    ],
  },
] as const;
    ...
    <main>
      ...
      <div className="mx-auto max-w-6xl px-4 py-12">
        <header className="mb-10 max-w-3xl">
          ...
          <h1 className="text-4xl font-bold tracking-tight">Texas Tools</h1>
          <p className="mt-4 text-lg text-muted-foreground">
            Free calculators for two important journeys: moving to Texas and making better decisions
        ...
        <section className="mb-12 rounded-2xl border bg-gray-50 p-6">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Choose the closest situation and go directly to the best starting point.
          </p>
              ...
              <div className="space-y-3">
                {group.tools.map(([title, to, description]) => (
                  <Link
                    key={`${group.title}-${to}`}
                    to={to}
                    className="block rounded-xl border bg-background p-5 transition hover:-translate-y-0.5 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-red-700"
                  >
        ...
        <aside className="mt-12 rounded-xl border p-5 text-sm text-gray-600">
          ...
          <p className="mt-2">
            Inputs and saved scenarios stay in your browser unless a page explicitly says otherwise.
            Default values are illustrative Texas estimates, not quotes or official eligibility
            decisions. Each calculator identifies its assumptions, model version, last review date,
            and limitations.
          </p>
        </aside>
      </div>
