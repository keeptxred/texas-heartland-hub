  ...
  head: ({ match }) => {
    ...
    return {
      meta: [
        ...
        { name: "description", content: "Coverage of Texas elections, legislative districts, government, policy trackers, Texas law guides, official data sources, and political developments from Austin to the precinct." },
