...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Keep TX Red — Texas Conservative News & Tools" },
      { name: "description", content: "Conservative Texas political news, election coverage, and a property tax calculator by county including school district taxes." },
      { property: "og:title", content: "Keep TX Red — Texas Conservative News & Tools" },
      { property: "og:description", content: "Conservative Texas political news, election coverage, and a property tax calculator by county including school district taxes." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Keep TX Red" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Keep TX Red — Texas Conservative News & Tools" },
