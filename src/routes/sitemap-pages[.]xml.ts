...
const STATIC_PATHS: string[] = [
  ...
  "/texas-sales-tax-explained", "/texas-first-time-homebuyer-programs", "/find-my-dmv",
  "/texas-living", "/texas-resources", "/texas-down-payment-calculator", "/texas-closing-cost-calculator",
  "/texas-home-equity-growth-calculator", "/texas-mortgage-payoff-calculator",
  "/texas-homeownership-cost-calculator", "/texas-refinance-savings-calculator", "/texas-home-equity-calculator",
  "/texas-budget-planner", "/texas-down-payment-assistance-calculator", "/texas-salary-comparison-by-city",
  ...
  "/authors", "/texas-economy", "/texas-law-policy", "/shop", "/texas", "/texas/property-taxes-2026",
