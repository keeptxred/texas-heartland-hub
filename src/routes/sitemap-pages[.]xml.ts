...
const STATIC_PAGE_LASTMOD_OVERRIDES: Record<string, string> = {
  ...
  "/texas-politics/texas-political-geography-history": POLITICAL_HISTORY_REFRESH,
  "/texas-politics/texas-urban-suburban-rural-politics-history": POLITICAL_HISTORY_REFRESH,
  "/texas-politics/south-texas-rio-grande-valley-political-history": POLITICAL_HISTORY_REFRESH,
  "/texas-politics/texas-metro-regional-realignment-history": POLITICAL_HISTORY_REFRESH,
...
const STATIC_PATHS:string[]=[
  ...
  "/texas-politics/texas-political-geography-history","/texas-politics/texas-urban-suburban-rural-politics-history","/texas-politics/south-texas-rio-grande-valley-political-history","/texas-politics/texas-metro-regional-realignment-history",
