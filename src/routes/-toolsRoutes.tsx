/* eslint-disable react-refresh/only-export-components -- static route-card registry */
...
export const toolsRoutes = [
  {
    ...
    element: lazyPage(ToolsIndex),
  },

  {
    path: "/tools/mortgage-calculator",

    element: lazyPage(MortgageCalculator),
  },

  {
    path: "/tools/property-tax-calculator",

    element: lazyPage(PropertyTaxCalculator),
  },

  {
    path: "/tools/home-insurance-calculator",

    element: lazyPage(HomeInsuranceCalculator),
  },

  {
    path: "/tools/home-affordability-calculator",

    element: lazyPage(HomeAffordabilityCalculator),
  },

  {
    path: "/tools/closing-cost-calculator",

    element: lazyPage(ClosingCostCalculator),
  },

  {
    path: "/tools/texas-utilities-calculator",

    element: lazyPage(TexasUtilitiesCalculator),
  },
];
