    ...
    const bodyJson = {
      ...
      sections: [
        ...
        ...ai.value.sections,
        {
          ...
          paragraphs: [`Keep TX Red synthesized this report from ${packet.sources.length} source${packet.sources.length === 1 ? "" : "s"}. Claims remain attributed to the originating reports and direct primary material is preferred where available.`],
        },
      ],
      faq: ai.value.faq,
      sources,
