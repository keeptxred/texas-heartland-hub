...
export const Route = createFileRoute("/news/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conservative news from Austin to the border — elections, government, laws, legislature, energy, education, and tax policy from the Lone Star State." },
      { property: "og:title", content: "Texas Political News — Keep TX Red" },
      { property: "og:description", content: "Conservative reporting on Texas politics, legislation, government, law, and policy." },
    ...
    <div className="mx-auto max-w-6xl px-4 py-14">
      <div className="border-b-2 border-foreground pb-4 mb-8">
        ...
        <p className="mt-3 text-muted-foreground max-w-2xl">
          Independent conservative reporting on Texas elections, government, law, the legislature, border security, energy, education, and tax policy. Updated every morning at 2:00 AM Central.
        </p>
