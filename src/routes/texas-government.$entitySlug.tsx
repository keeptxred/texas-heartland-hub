    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,2fr)_minmax(280px,1fr)]">
        <main className="space-y-8">
          ...
          <AuthoritySection id="elections" title="Related elections" icon={<Gavel className="h-6 w-6 text-primary"/>}><LinkGrid links={entity.relatedElections.length ? entity.relatedElections : [{ label: "Texas Election Central", href: "/elections/2026", description: "Statewide, legislative and judicial election coverage." }]} /></AuthoritySection>
