...
const tracker = POLICY_TRACKERS_WAVE8.find((item) => item.slug === "career-technical-workforce")!;

export const Route = createFileRoute("/policy/career-technical-workforce")({
