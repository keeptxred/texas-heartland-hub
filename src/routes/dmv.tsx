...
const serviceGroups = [
  ...
  },
  {
    ...
    description: "Prepare for a first license, an identification card, an out-of-state transfer, REAL ID, and the documents DPS may require.",
    resources: [
  ...
  },
  {
    ...
    description: "Renew a credential, replace a lost or stolen card, update your address, or check whether your driving privilege is eligible.",
    resources: [
  ...
  },
  {
    ...
    description: "Coordinate the separate deadlines for registering a vehicle and obtaining a Texas driver license or identification card.",
    resources: [
      ["Complete Texas Driver License Guide", "/dmv/driver-license"],
      ["Texas Identification Card Guide", "/dmv/identification-card"],
      ["Texas DPS Appointment Guide", "/dmv/dps-appointments"],
...
export const Route = createFileRoute("/dmv")({
  head: () => {
    const seo = buildSeo({ title: "Texas DMV & DPS: Driver Licenses, ID Cards, Status & Appointments", description: "Texas DMV and DPS guides for driver licenses, identification cards, license status, DPS appointments, REAL ID, registration, titles, plates, and offices.", path: "/dmv", type: "website", keywords: "Texas DMV, Texas identification card, Texas ID card, check Texas driver license status, Texas DPS appointment, Texas REAL ID, Texas vehicle registration" });
