  ...
  return (
    <main>
      ...
      <article className="mx-auto max-w-4xl space-y-10 px-4 py-14 leading-relaxed">
        ...
        <section className="rounded-xl border bg-muted/20 p-6"><h2 className="text-2xl font-bold">Moving checklist for Texas records</h2><ol className="mt-4 list-decimal space-y-2 pl-6"><li>Update DPS within 30 days.</li><li>Update vehicle title and registration records separately.</li><li>Update voter registration.</li><li>Notify your insurance carrier.</li><li>Update toll, tax, school, utility, and local-government accounts.</li></ol><p className="mt-4">Use the full <a className="text-primary underline underline-offset-4" href="/moving-to-texas-checklist">Texas moving checklist</a> for the rest of the move.</p></section>

        <section><h2 className="text-3xl font-bold">Related Keep TX Red guides</h2><div className="mt-5 grid gap-4 sm:grid-cols-2">{[["Texas Driver License Renewal", "/dmv/driver-license-renewal"],["Replace a Lost Texas Driver License", "/dmv/replace-lost-license"],["Complete Texas Driver License Guide", "/dmv/driver-license"],["Moving to Texas Resource Center", "/moving-to-texas"]].map(([title, href]) => <a key={href} href={href} className="rounded-xl border bg-card p-5 font-semibold hover:shadow-md">{title}<span className="mt-2 block text-sm text-primary">Open guide →</span></a>)}</div></section>
