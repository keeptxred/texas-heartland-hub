...
const SECTIONS = [
  ...
  { title: "Texas Democratic Party History", description: "How the Texas Democratic Party evolved from early statehood through one-party dominance, factional conflict and modern two-party competition.", href: "/texas-politics/texas-democratic-party-history" },
  { title: "Texas Republican Party History", description: "The Texas GOP from its biracial Reconstruction origins through minority status, conservative realignment and statewide control.", href: "/texas-politics/texas-republican-party-history" },
  { title: "Mexican American Political Organization", description: "LULAC, the American G.I. Forum, voter registration, MAYO, Raza Unida and the growth of Mexican American political representation.", href: "/texas-politics/texas-mexican-american-political-organization-history" },
  { title: "Women in Texas Politics", description: "Women's suffrage, voting-rights expansion and the long growth of women's political representation in Texas government.", href: "/texas-politics/texas-women-suffrage-political-representation-history" },
  { title: "Texas Political Geography", description: "How regions, counties, population growth and party coalitions built the statewide electoral map.", href: "/texas-politics/texas-political-geography-history" },
  { title: "Urban, Suburban & Rural Texas", description: "How cities, suburbs, exurbs and rural counties moved onto different partisan tracks.", href: "/texas-politics/texas-urban-suburban-rural-politics-history" },
  { title: "South Texas & Rio Grande Valley Politics", description: "Machines, voting rights, Mexican American political organization, Democratic strength and recent Republican gains.", href: "/texas-politics/south-texas-rio-grande-valley-political-history" },
  { title: "Texas Metro Realignment", description: "The separate political paths of Dallas-Fort Worth, Houston, Austin and San Antonio and their suburban rings.", href: "/texas-politics/texas-metro-regional-realignment-history" },
