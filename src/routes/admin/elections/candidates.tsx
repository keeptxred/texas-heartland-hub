...
import { ElectionAdminCandidateList } from "@/components/admin/elections";
import { ElectionRepositoryProvider } from "@/lib/elections/repositories";

export const Route = createFileRoute("/admin/elections/candidates")({
  head: () => ({
    meta: [
      { title: "Election Candidates — Keep TX Red Admin" },
