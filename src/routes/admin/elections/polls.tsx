...
import { ElectionAdminPollList } from "@/components/admin/elections";
import { ElectionRepositoryProvider } from "@/lib/elections/repositories";

export const Route = createFileRoute("/admin/elections/polls")({
  head: () => ({
    meta: [
      { title: "Election Polls — Keep TX Red Admin" },
