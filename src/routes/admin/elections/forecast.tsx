...
import { ElectionAdminForecastList } from "@/components/admin/elections";
import { ElectionRepositoryProvider } from "@/lib/elections/repositories";

export const Route = createFileRoute("/admin/elections/forecast")({
  head: () => ({
    meta: [
      { title: "Election Forecasts — Keep TX Red Admin" },
