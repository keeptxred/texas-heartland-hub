...
function Page() {
  ...
  return <div className="min-h-screen bg-white">
    <header className="border-b-4 border-primary bg-secondary text-white"><div className="mx-auto max-w-6xl px-4 py-8"><a href="/admin" className="text-sm hover:underline">← Editorial Dashboard</a><h1 className="mt-3 text-4xl font-bold">Governance Health</h1><p className="mt-2 max-w-3xl text-sm text-white/80">Privacy-safe publication decisions, override activity, and canonical-ownership drift. The current buffer resets when the server instance restarts.</p></div></header>
