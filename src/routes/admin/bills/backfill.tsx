...
function BackfillDashboard() {
  ...
  async function runPass() {
    setRunning(true);
    setMessage('Running one bounded server backfill pass…');
    ...
    <div className="min-h-screen bg-white">
      <header className="border-b-4 border-primary bg-secondary text-secondary-foreground">
        <div className="mx-auto max-w-6xl px-4 py-8">
          ...
          <p className="mt-2 text-sm text-white/85">Run bounded official-subject and relationship passes on the Keep TX Red server.</p>
        </div>
      </header>
