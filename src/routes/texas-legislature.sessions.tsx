...
export const Route = createFileRoute("/texas-legislature/sessions")({
  head: () => legislatureSeo({ title, description, path: "/texas-legislature/sessions", breadcrumb: "Past Sessions" }),
  component: () => <TexasLegislaturePage page="past" />,
});
