...
import { detectSearchTelemetryAnomalies } from './search-telemetry-anomalies';
...
export type SearchTelemetryDigest = {
  ...
  anomalies: ReturnType<typeof detectSearchTelemetryAnomalies>;
...
export function buildSearchTelemetryDigest(
  ...
  options: Parameters<typeof detectSearchTelemetryAnomalies>[1] & { generatedAt?: string } = {},
  ...
  const anomalies = detectSearchTelemetryAnomalies(events, anomalyOptions);
