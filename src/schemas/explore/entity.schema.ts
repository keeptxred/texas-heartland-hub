...
import { EXPLORE_ENTITY_STATUSES, EXPLORE_VISIBILITIES } from "@/types/explore";
...
export const exploreEntityCreateSchema = exploreEntityBaseSchema.superRefine((value, context) => {
  if (
