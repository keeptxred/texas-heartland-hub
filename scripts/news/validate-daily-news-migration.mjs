...
for (const file of files) {
  ...
  if (isBulkArticleMaintenance) {
    ...
    if (!safelyScoped) errors.push('BULK_ARTICLE_MAINTENANCE must be update-only and narrowly scoped by an explicit dated slug, a guarded legacy category/site-boundary predicate, or the restored-legacy <500-word quarantine contract');
  }
