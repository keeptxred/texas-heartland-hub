...
const retiredFiles = [
  ...
  'src/shared/texas-platform/entity-components.tsx',
  'src/shared/texas-platform/search-telemetry-components.tsx',
  'src/shared/texas-platform/provider-health-components.tsx',
  'src/shared/texas-platform/resource-hub-personalization.ts',
  'src/shared/texas-platform/resource-hub-personalization-storage.ts',
  'src/shared/texas-platform/resource-hub-personalization.test.ts',
  'src/shared/texas-platform/resource-hub-personalization-storage.test.ts',
  'src/shared/texas-platform/collections.ts',
  'src/shared/texas-platform/collections.test.ts',
  'src/shared/texas-platform/collection-ranking.ts',
  'src/shared/texas-platform/collection-ranking.test.ts',
