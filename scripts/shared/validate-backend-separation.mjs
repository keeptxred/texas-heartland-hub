...
for (const [file, target] of redirects) {
  ...
  for (const forbidden of ['component:', 'canonicalLink(', 'buildMeta(', 'TaxCalculator', 'MovingChecklist']) {
...
if (!fs.existsSync(sitemapPath)) errors.push(`Missing ${sitemapPath}`);
  ...
  for (const path of ['/tax-calculator', '/texas-property-tax-protest-guide', '/texas-property-tax-increase-calculator', '/moving-to-texas-checklist']) {
