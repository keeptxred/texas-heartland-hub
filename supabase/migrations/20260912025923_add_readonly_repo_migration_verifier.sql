-- Read-only, service-role-only verifier used by CI when direct database
-- migration credentials are unavailable. This function does not execute SQL;
-- it only reports whether expected migration versions exist in the ledger.
