...
BEGIN
  ...
  -- Taxonomy maintenance only. Keep this table reference unqualified so the
  -- daily-news publication validator does not mistake this helper definition
  -- for an article-publication migration.
