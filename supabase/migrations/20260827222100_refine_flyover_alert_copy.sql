-- Refine the alert copy while preserving the ledger-derived synchronization.
...
begin
  ...
  values (
    ...
    format('Aug. 10 Flyover reconciliation: %s stories are source-backed and held for editorial review; none should auto-publish. Published: %s. Out of scope: %s. See flyover_aug10_reconciliation for exact feed IDs and evidence.', review_count, published_count, out_of_scope_count),
    now(),
