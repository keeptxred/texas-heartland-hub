-- A legitimate MLB headline can abbreviate context to "Series Preview" around
-- the Rangers name. Accept that narrow baseball framing without weakening the
-- Texas Rangers law-enforcement exclusion.
