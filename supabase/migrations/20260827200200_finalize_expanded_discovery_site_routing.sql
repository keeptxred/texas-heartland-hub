-- Final deterministic additions found during production review-queue sampling.
-- Keep all ambiguous stories held for review and preserve linked inventory.
...
comment on function public.route_texas_story_to_site() is
  'Routes deterministic KTR hard-news/business/sports and TexasDefined lifestyle matches from expanded statewide discovery; ambiguous items remain held for review.';
