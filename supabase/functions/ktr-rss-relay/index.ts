...
const FEEDS: Record<string, string> = {
  ...
  "google-texas-business-longtail": "https://news.google.com/rss/search?q=(Texas+trucking+OR+%22Texas+Trucking+Association%22+OR+Texas+cattle+imports+OR+Texas+wine+harvest+OR+Texas+tourism+impact+OR+Texas+freight+OR+Texas+logistics+OR+%22Goodfellow+Air+Force+Base%22)+when%3A4d&hl=en-US&gl=US&ceid=US%3Aen",
