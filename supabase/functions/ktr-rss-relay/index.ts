...
const FEEDS: Record<string, string> = {
  ...
  "google-pro-sports": "https://news.google.com/rss/search?q=%28Dallas+Mavericks+OR+Dallas+Cowboys+OR+Texas+Rangers+OR+Houston+Astros+OR+Houston+Texans+OR+San+Antonio+Spurs%29+when%3A2d&hl=en-US&gl=US&ceid=US%3Aen",
