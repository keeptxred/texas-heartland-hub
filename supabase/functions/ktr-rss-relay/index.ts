...
const FEEDS: Record<string, string> = {
  ...
  "google-texas-business-longtail": "https://news.google.com/rss/search?q=%28%22Texas+Trucking+Association%22+OR+%22diesel+prices%22+Texas+OR+%22cattle+imports%22+%22Santa+Teresa%22+OR+%22Texas+wine+grape%22+OR+%22Texas+wine+harvest%22+OR+%22tourism+impact%22+Texas+OR+%22economic+impact%22+Texas+tourism+OR+%22Goodfellow+Air+Force+Base%22+OR+Christoval+Road+Texas+OR+Texas+freight+OR+Texas+logistics%29+when%3A7d&hl=en-US&gl=US&ceid=US%3Aen",
  "google-texas-campus-longtail": "https://news.google.com/rss/search?q=(Texas+university+ranking+OR+Texas+college+ranking+OR+Texas+university+research+OR+Texas+student+award+OR+Texas+campus+archive+OR+Texas+nuclear+reactor+OR+%22Abilene+Christian+University%22)+when%3A4d&hl=en-US&gl=US&ceid=US%3Aen",
  "google-texas-community-longtail": "https://news.google.com/rss/search?q=(Texas+community+tradition+OR+Texas+local+record+OR+Texas+student+recognition+OR+Texas+parade+OR+Texas+honorary+OR+Texas+prayer+event+OR+Texas+local+oddity+OR+Texas+human+interest)+when%3A4d&hl=en-US&gl=US&ceid=US%3Aen",
  "google-texas-sports-longtail": "https://news.google.com/rss/search?q=(Texas+high+school+volleyball+OR+Texas+high+school+football+OR+Texas+athlete+injury+OR+Texas+sports+record+OR+Texas+college+football+injury+OR+Texas+WNBA+OR+%22Texas+Girls+Coaches+Association%22)+when%3A3d&hl=en-US&gl=US&ceid=US%3Aen",
